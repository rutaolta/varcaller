rule draw_variant_window_densities:
    input:
        vcf=vcf_subset_dir_path / "{subset}/{assembly}.{var_type}.{zygosity}.vcf.gz",
    ...
    output:
        png=vcf_subset_dir_path / "{subset}/{assembly}.{var_type}.{zygosity}.{size_and_step}.jet.png",
        svg=vcf_subset_dir_path / "{subset}/{assembly}.{var_type}.{zygosity}.{size_and_step}.jet.svg",
        scaffolds_absent_in_reference=vcf_subset_dir_path / "{subset}/{assembly}.{var_type}.{zygosity}.{size_and_step}.scaffolds_absent_in_reference.ids",
        scaffolds_absent_in_vcf=vcf_subset_dir_path / "{subset}/{assembly}.{var_type}.{zygosity}.{size_and_step}.scaffolds_absent_in_vcf.ids",
        short_scaffolds=vcf_subset_dir_path / "{subset}/{assembly}.{var_type}.{zygosity}.{size_and_step}.short_scaffolds.ids",
    ...
    log:
        std=log_dir_path / "{subset}/{assembly}.{var_type}.{zygosity}.{size_and_step}.draw_variant_window_densities.log",
        cluster_log=cluster_log_dir_path / "{subset}/{assembly}.{var_type}.{zygosity}.{size_and_step}.draw_variant_window_densities.cluster.log",
        cluster_err=cluster_log_dir_path / "{subset}/{assembly}.{var_type}.{zygosity}.{size_and_step}.draw_variant_window_densities.cluster.err"
    benchmark:
        benchmark_dir_path / "{subset}/{assembly}.{var_type}.{zygosity}.{size_and_step}.draw_variant_window_densities.benchmark.txt"
    conda:
